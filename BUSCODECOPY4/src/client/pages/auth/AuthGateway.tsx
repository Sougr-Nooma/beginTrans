...
import { User, Building2, ArrowLeft, Mail, Phone, ShieldCheck, Lock, CheckCircle2, Info, ArrowRight, Bus } from 'lucide-react';
...
interface AuthGatewayProps {
  onLogin: (user: { name: string; email: string; phone?: string; role: 'CLIENT' | 'COMPANY' | 'ADMIN'; companyId?: string }) => void;
  onClose: () => void;
  existingCompanies: BusCompany[];
  onAddCompany: (company: BusCompany) => void;
}

export function AuthGateway({ onLogin, onClose, existingCompanies, onAddCompany }: AuthGatewayProps) {
  // Mode: null means choosing role, 'CLIENT' means client flow, 'COMPANY' means company flow
  const [selectedRole, setSelectedRole] = useState<'CLIENT' | 'COMPANY' | null>(null);
  
  // CLIENT side state: 'LOGIN' or 'REGISTER'
    ...
    try {
      if (companyMode === 'REGISTER') {
        ...
        onAddCompany({
          ...
          logo: "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?auto=format&fit=crop&q=80&w=200",
          rating: 4.5,
          description: newCompany.description || `Compagnie partenaire de FasoBus. Services de qualité.`,
            ...
            {selectedRole === null ? (
              ...
              >
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-500 font-medium max-w-md mx-auto">
                    Sélectionnez votre profil d'authentification pour commencer
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 font-semibold leading-relaxed">
                        Pour rechercher des bus, acheter vos billets par Mobile Money et gérer votre historique.
                      </p>
                    </div>
                  </motion.button>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 font-semibold leading-relaxed">
                        Pour gérer vos flottes de bus, ajouter vos programmations et suivre vos réservations en temps réel.
                      </p>
                    </div>
                  </motion.button>
                </div>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    {companyMode === 'LOGIN' ? "Accédez aux outils d'administration de votre compagnie." : "Rejoignez FasoBus pour booster vos réservations."}
                  </p>
                </div>
                ...
                <form onSubmit={handleCompanySubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        placeholder="Ex: tsr, rts, elitis, skv"
                  ...
                  {companyMode === 'REGISTER' && (
                    <>
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Brève description de la compagnie (facultatif)</label>
                        <textarea 
